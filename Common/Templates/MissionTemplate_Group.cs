...
namespace Common.Templates
{
    ...
    public class MissionTemplate_Group
    {
        ...
        [JsonPropertyOrder(7)] public int seq { get; set; }
        [JsonPropertyOrder(8)] public bool isLook { get; set; }
        [JsonPropertyOrder(9)] public List<Parameter> parameters { get; set; } = new List<Parameter>();
        [JsonPropertyOrder(10)] public string parametersJson { get; set; }        // DB 파라메타를 저장하기 위하여
        [JsonPropertyOrder(11)] public List<PreReport> preReports { get; set; } = new List<PreReport>();
        [JsonPropertyOrder(12)] public string preReportsJson { get; set; }        //Mission 전에 보내지는 Report
        [JsonPropertyOrder(13)] public List<PostReport> postReports { get; set; } = new List<PostReport>();
