...
{
    public class Post_MissionTemplate_Group
    {
        ...
        [JsonPropertyOrder(6)] public int seq { get; set; }
        ...
        [JsonPropertyOrder(10)] public List<PostReport> postReports { get; set; } = new List<PostReport>();
